    ...
    setTimeout(async () => {
      try {
        ...
        const locationMatchingTradespeople = matchingTradespeople.filter(tradesperson => {
          ...
          return tradespersonLocation.toLowerCase().includes(jobLocation.toLowerCase()) ||
                 jobLocation.toLowerCase().includes(tradespersonLocation.toLowerCase());
        });
            ...
            const mailOptions = {
              ...
              html: `<div style="font-family:Arial,sans-serif;max-width:600px;margin:auto;padding:20px;border:1px solid #eee;border-radius:8px;">
                ...
                <div style="padding:20px;">
                  ...
                  <p>A new <strong>${job.trade}</strong> job has been approved and is now available in your area that matches your skills and location.</p>
                  ...
                  <div style="background-color:#e6fffa;padding:16px;border-radius:8px;margin:16px 0;border-left:4px solid #38b2ac;">
                    ...
                    <p style="margin:0;color:#2c7a7b;">
                      This job matches your trade (${job.trade}) and location (${tradesperson.postcode || tradesperson.city}). 
